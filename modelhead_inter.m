...
% figure(4);
% bar([betsInflow, optionRevenue, betsOutflow, optionExpenditure, totalProfit])
% title('Cash Flow Distribution');
% set(gca,'XTickLabel',{'BetsInflow', 'OptionRevenue', 'BetsOutflow', 'OptionExpenditure', 'Net'})

if totalProfit <0
    negs=negs+1;
    totalloss=totalloss+totalProfit;
else
    totalgains=totalgains+totalProfit;
end
j=j+1;

end
negrat=negs/1000
TOTAL=totalloss+totalgains
